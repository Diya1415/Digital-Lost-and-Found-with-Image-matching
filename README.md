...
This project was built during VIBE-A-THON: Rapid Innovation Challenge, an intra-college hackathon organized by the IEEE Computer Society at KLE Institute of Technology in collaboration with OS-Code.
...
- Location-based filtering (e.g., departments, seminar halls, hostels)
- Searchable lost-and-found item listings
- Prototype notification system for potential matches
- Tech Stack
- Frontend: React / Next.js
- Backend: Node.js
- AI / Image Matching: AI-based image similarity tools
- Deployment: Vercel
...
- These features are compared with images stored in the system.
